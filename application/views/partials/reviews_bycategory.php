                ...
                <div class="row">
                    <?php foreach($reviews_bycategory as $review)
                        {
                    ?>
                    ...
                    <div class="col-sm-4 col-lg-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p class="review_p"><a class="review_a" href=""><?=$review['name']?> </a> says: <?=$review['review']?></p>
                                <p>Posted on 
                                <?php 
                    ...
                    <?php
                        ...
                        {
                    ?>
                            <h4><a href="/Books/post_review">Add a book and post review</a></h4>
                    <?php
                        }
                    ?>
                    </div>
